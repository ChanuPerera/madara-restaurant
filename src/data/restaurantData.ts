...
export const MENU_CATEGORIES = [
  ...
  { id: "rice", name: "Rice", sinhalaName: "බත්", icon: "Soup" },
  { id: "kottu", name: "Kottu", sinhalaName: "කොත්තු", icon: "ChefHat" },
  { id: "other", name: "Other", sinhalaName: "වෙනත්", icon: "Sparkles" },
];
...
export const MENU_ITEMS: MenuItem[] = [
  // 1. RICE
  {
    ...
    tags: ["Mongolian Rice", "Live Wok", "Fusion"],
    allergens: ["Crustaceans / Prawns", "Egg", "Soy"],
  },
  {
    id: "rice-1",
  ...
  },
  {
    ...
    allergens: ["Egg", "Fish / Seafood paste"],
  },
  ...
  // 2. KOTTU
  {
    ...
    tags: ["Cheese Kottu", "Sri Lankan", "Hot & Cheesy"],
    allergens: ["Dairy / Mozzarella Cheese", "Egg", "Wheat / Gluten"],
  },
  ...
  // 3. OTHER DISHES
  {
    ...
    tags: ["Seafood", "Sizzling", "Black Pepper"],
    allergens: ["Crustaceans / Shellfish", "Dairy / Butter"],
  },
  {
    id: "sig-3",
    ...
    tags: ["Indian", "Tandoor", "Butter Chicken"],
    allergens: ["Dairy", "Tree Nuts / Cashews", "Wheat / Gluten"],
  },
  {
    id: "wok-2",
    ...
    tags: ["Spicy Wok", "Seafood", "Noodles"],
    allergens: ["Crustaceans / Prawns", "Mollusks / Cuttlefish", "Egg", "Wheat / Gluten"],
  },
  {
    id: "wok-3",
  ...
  },
  {
    ...
    tags: ["Sri Lankan Heritage", "Authentic Crab"],
    allergens: ["Crustaceans / Mud Crab", "Wheat / Gluten (Paan)"],
  },
  {
    id: "sl-2",
    ...
    image: "https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?auto=format&fit=crop&w=800&q=80",
    tags: ["Village Heritage", "Spicy Black Curry"],
    allergens: ["Wheat / Gluten (Pol Rotti)"],
  },
  {
    id: "sl-3",
    ...
    category: "other",
    priceLKR: 1950,
    description: "Whole plump raw cashews gently stewed in fragrant first-press coconut milk, cardamom, curry leaves, and green peas.",
    portion: "Medium Bowl",
    isVegetarian: true,
    image: "https://images.unsplash.com/photo-1585937421612-70a008356fbe?auto=format&fit=crop&w=800&q=80",
    tags: ["Vegetarian", "Royal Curry"],
  ...
  },
  {
    ...
    allergens: ["Crustaceans / Prawns", "Dairy / Butter"],
  },
  {
    id: "sea-2",
    ...
    tags: ["Devilled", "Cuttlefish"],
    allergens: ["Mollusks / Cuttlefish"],
  },
  {
    id: "byob-1",
    ...
    tags: ["Hot Butter", "Crowd Favorite"],
    allergens: ["Mollusks / Cuttlefish", "Egg", "Dairy / Butter"],
  },
  {
    id: "byob-2",
    name: "Spicy Pepper Beef Bites",
    ...
    tags: ["Beef Bites", "Pepper Fry"],
  },
  {
    id: "byob-3",
    name: "Fried Handalla / Silver Fish Bowl",
    sinhalaName: "බැදපු හාල්මැස්සෝ / හඳැල්ලෝ",
    category: "other",
    priceLKR: 1650,
  ...
  },
  {
    ...
    allergens: ["Dairy", "Tree Nuts / Walnuts", "Wheat / Gluten", "Egg"],
  },
  {
    id: "des-2",
    ...
    allergens: ["Egg", "Tree Nuts / Cashews"],
  },
  {
    id: "des-3",
