...
export const MENU_CATEGORIES = [
  ...
  { id: "other", name: "Other", sinhalaName: "වෙනත් (Other)", icon: "Sparkles" },
];

export const MENU_ITEMS: MenuItem[] = [
  // 1. Fried Rice (Basmathi) - Category: Rice
  {
    id: "fr-bas-veg",
    name: "Vegetable Fried Rice (Basmathi)",
    sinhalaName: "එළවළු ෆ්‍රයිඩ් රයිස් (බස්මති)",
    category: "rice",
    subCategory: "Fried Rice (Basmathi)",
    priceLKR: 550,
  ...
  // 3. Chopsy Rice (Basmathi) - Category: Rice
  {
    id: "chopsy-veg",
    name: "Vegetable Rice (Chopsy)",
    sinhalaName: "එළවළු චොප්සි බත් (බස්මති)",
    category: "rice",
    subCategory: "Chopsy Rice (Basmathi)",
    priceLKR: 1450,
  ...
  // 5. Koththu & Cheese Koththu - Category: Kottu
  {
    id: "kottu-veg",
    name: "Vegetable Koththu",
    sinhalaName: "එළවළු කොත්තු",
    category: "kottu",
    subCategory: "Koththu & Cheese Koththu",
    priceLKR: 450,
  ...
  // 6. Side Dishes — Chicken - Category: Other
  {
    id: "side-chicken-devel",
    name: "Chicken Devel",
    sinhalaName: "චිකන් ඩෙවල්",
    category: "other",
    subCategory: "Side Dishes — Chicken",
    priceLKR: 1300,
  ...
  // 7. Side Dishes — Fish - Category: Other
  {
    id: "side-fish-fried",
    name: "Fried Fish",
    sinhalaName: "බැදපු මාළු",
    category: "other",
    subCategory: "Side Dishes — Fish",
    priceLKR: 1500,
  ...
  // 9. Side Dishes — Pork - Category: Other
  {
    id: "side-pork-devilled",
    name: "Devilled Pork",
    sinhalaName: "පෝර්ක් ඩෙවල්",
    category: "other",
    subCategory: "Side Dishes — Pork",
    priceLKR: 1550,
  ...
  // 10. Side Dishes — Egg - Category: Other
  {
    id: "side-egg-bullseye",
    name: "Bullseye",
    sinhalaName: "බුල්සයි බිත්තරය",
    category: "other",
    subCategory: "Side Dishes — Egg",
    priceLKR: 100,
  ...
  // 11. Side Dishes — Vegetable - Category: Other
  {
    id: "side-veg-boiled",
    name: "Boiled Vegetables",
    sinhalaName: "තම්බන ලද එළවළු",
    category: "other",
    subCategory: "Side Dishes — Vegetable",
    priceLKR: 950,
  ...
  // 12. Side Dishes — Seafood - Category: Other
  {
    id: "side-seafood-devilled-prawn",
    name: "Devilled Prawn",
    sinhalaName: "ඉස්සෝ ඩෙවල්",
    category: "other",
    subCategory: "Side Dishes — Seafood",
    priceLKR: 1450,
