...
const HERO_SLIDES: HeroSlide[] = [
  {
    ...
    descriptionEn: "We deliver full-scale luxury event catering, itemized buffet setups, chafing warmers, and tailored packages for weddings, alms givings, birthdays, and corporate events across Homagama and Colombo.",
    descriptionSi: "අපි හෝමාගම සහ කොළඹ අවට විවාහ මංගල්‍ය, දානමය පිංකම්, උපන්දින සාද සහ ආයතනික උත්සව සඳහා උසස් තත්ත්වයේ කේටරින් සේවා, බුෆේ උපකරණ සහ විශේෂිත ආහාර මෙනු සපයන්නෙමු.",
  ...
  },
  {
    ...
    descriptionEn: "Electrify your event with on-site live cooking stations! Master chefs tossing Mongolian wok bowls, molten cheese kottu, sizzling BBQ grills, and authentic hopper fiestas in front of your guests.",
    descriptionSi: "ඔබේ උත්සව භූමියටම පැමිණෙන සජීවී ආහාර පිසීමේ කුටි! මොන්ගෝලියන් වොක්, චීස් කොත්තු, බාබකියු සහ උණු උණු ආප්ප සජීවීව පිළියෙළ කෙරේ.",
  ...
  },
  {
    ...
    descriptionEn: "Enjoy relaxing evenings with no corkage fee. We provide chilled rock glassware, ice boxes, ambient indoor/garden seating, and a fiery spread of hot butter cuttlefish, devilled meats, and sizzlers.",
    descriptionSi: "කිසිදු අමතර ගාස්තුවකින් තොරව ඔබේ ප්‍රියතම පාන වර්ග රැගෙන එන්න. සිසිල් කළ වීදුරු, අයිස් සහ රසවත් හොට් බටර් දැල්ලෝ, ඩෙවල් බයිට්ස් සමඟ සුවපහසු පරිසරය.",
    badgeEn: "Chilled Glassware • Ice Buckets • Hot Bites",
    badgeSi: "සිසිල් කළ වීදුරු • අයිස් • රසවත් බයිට්ස්",
    ctaPrimaryEn: "Discover BYOB Experience",
    ctaPrimarySi: "BYOB අත්දැකීම",
    ctaPrimaryHref: "#byob",
    statNumber: "0 LKR",
  ...
  },
  {
    ...
    descriptionEn: "From aromatic saffron dum biryanis and lagoon black pepper prawns to village-style claypot curries and fresh juices — explore our extensive dine-in, takeaway, and delivery menu.",
    descriptionSi: "සුවඳැති දම් බිරියානි, බ්ලැක් පෙපර් ඉස්සෝ සිස්ලර්, සාම්ප්‍රදායික ගමේ කෑම සහ නැවුම් බීම වර්ග — අපගේ සම්පූර්ණ ආහාර මෙනුව දැන්ම පිරික්සන්න.",
